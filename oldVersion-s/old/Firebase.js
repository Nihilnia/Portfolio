...
export const countPortfolioCollection = collection(db, "countPortfolio");
export const countProjektsCollection = collection(db, "countProjekts");
export const countNavBarCollection = collection(db, "countNavBar");
export const countFooterCollection = collection(db, "countFooter");
